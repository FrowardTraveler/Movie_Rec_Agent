...
class RecommendationEngineAdapter:
    ...
    async def initialize(self):
        ...
        try:
            ...
            spec = importlib.util.spec_from_file_location(
                ...
                f"{engine_path}/online/pipeline.py"
            )
    ...
    async def get_recommendations(
        ...
        try:
            ...
            if self._engine:
                # 如果有现有引擎，使用它
                recommendations = await self._call_existing_engine(
                    user_features, context, top_k
                )
            else:
                # 否则使用模拟实现
                recommendations = await self._mock_recommendations(
    ...
    async def _call_existing_engine(
        ...
        try:
            ...
            return await self._mock_recommendations(
                user_features.get("user_id", "unknown"), 
                context, 
                top_k
            )
