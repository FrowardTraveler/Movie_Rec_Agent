...
class LLMRouter:
    ...
    def __init__(self):
        ...
        self._circuit_breaker = CircuitBreaker(
            name="LLM服务", failure_threshold=5, recovery_timeout=60, success_threshold=2
        )
    ...
    async def call_llm(self, messages: list[BaseMessage], **kwargs):
        ...
        """
        try:
            return await self._circuit_breaker.call(self._llm.ainvoke, messages, **kwargs)
        except CircuitBreakerOpenError as e:
            logger.warning("LLM 服务已熔断，降级到 MockLLM", remaining=e.remaining_seconds)
